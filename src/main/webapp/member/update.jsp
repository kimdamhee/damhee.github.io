...
<script>
	...
	<div class="pf-container">
		<h4>My Info Update</h4>
	
		<div class="mb-container join-container">
			<form name="regFrm" action="updatePro.jsp" method="post">
				<ul>
				...
				<div class="flex">
					<button type="submit" class="btn btn-blue">정보수정</button>
					<a href="mypage.jsp" class="btn btn-white">나의정보</a>
				</div>
			</form>
		</div>
	</div>
