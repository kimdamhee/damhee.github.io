...
<script>
	...
	<div class="pf-container">
		<h4>Member Info Update</h4>
	
	
		<div class="mb-container join-container">
			<form name="updateFrm" action="admin-updatePro.jsp" method="post">
				<ul>
			...
			<form name="deleteFrm" action="admin-deletePro.jsp" method="post">
				<input type="hidden" name="userid" value="<%=id %>" >
			</form>
			
			<div class="flex">
				<button onClick="updateMember()" class="btn btn-blue">회원정보수정</button>
				<button onClick="deleteMember()" class="btn btn-orange" >회원삭제</button>
				<a href="admin-memberList.jsp" class="btn btn-white" >회원목록</a>
			</div>
		</div>
	</div>
